...
public class ScrollingNumbersView extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    public ScrollingNumbersView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ScrollingNumbersView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.ScrollingNumbersView);
...
//        Typeface tf = Typeface.createFromAsset(context.getAssets(), "keyin.otf");
//        setPaintTypeface(Typeface.create(tf, styleIndex));
    ...
    public void addScrollingNumber(ScrollingNumber sn, boolean toLeft) {
        if (toLeft) {
            mNumbers.add(0, sn);
        } else {
            mNumbers.add(sn);
    ...
    private void updateNumberLocation() {
        ...
        switch (mAlignment) {
            case ALIGNMENT_CENTER:
                Log.i("cyp","mShowingCount:"+mShowingCount+",mAdjustSubTextThreshold:"+mAdjustSubTextThreshold);
...
//        }
    ...
    public void addNewScrollingNumber(int digit,boolean isLeft){

    }

    public class ScrollingNumber implements ValueAnimator.AnimatorUpdateListener,
        ...
        private boolean mCanShowZero = true;
