...
public class MediaManager {
     ...
     *
     * @param context
     * @param filePath  he path of the file, or the http/rtsp URL of the stream you want to play
    ...
    public static void playAssetsSound(Context context, AssetFileDescriptor fd) {
        if (mMediaPlayer == null) {
            mMediaPlayer = getMediaPlayer(context);
